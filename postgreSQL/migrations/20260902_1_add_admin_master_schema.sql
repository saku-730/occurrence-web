...
-- loaded.
CREATE TABLE admin_master.datasets (
...
CREATE TABLE admin_master.jp_prefectures (
...
CREATE TABLE admin_master.jp_municipalities (
...
CREATE INDEX idx_jp_municipalities_pref_code
...
CREATE TABLE admin_master.jp_machiaza (
...
CREATE INDEX idx_jp_machiaza_lg_code
...
CREATE INDEX idx_jp_machiaza_match_name
...
DROP SCHEMA admin_master CASCADE;
